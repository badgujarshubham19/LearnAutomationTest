...
public class Scenario20 {
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement target2 = driver.findElement(By.xpath("//span[contains(text(),'Coins by Design')]"));
		act.moveToElement(target2).click().perform();
		Thread.sleep(2000);
		WebElement target3 = driver.findElement(By.xpath("//div[@class='filter 10gms active']"));
